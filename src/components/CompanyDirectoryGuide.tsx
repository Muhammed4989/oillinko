  ...
  return (
    <section id="sourcing-guide" aria-labelledby="sourcing-guide-title" className="border-y border-line bg-oil-800">
      <div className="mx-auto max-w-6xl px-4 py-14">
        ...
        <div className="mt-10 flex flex-wrap gap-x-6 gap-y-3 border-t border-line pt-7 text-sm font-semibold text-accent"><Link href="/blog/category/oil-and-gas-procurement/supplier-selection-rfq/how-to-write-a-bill-of-quantities" className="underline">Preparing a bill of quantities</Link><Link href="/blog/category/oil-and-gas-procurement/supplier-selection-rfq/common-reasons-an-rfq-goes-to-the-wrong-supplier" className="underline">Choosing the right RFQ recipient</Link><Link href="/suppliers" className="underline">Oillinko’s supplier qualification approach</Link></div>
      </div>
    </section>
  );
}
