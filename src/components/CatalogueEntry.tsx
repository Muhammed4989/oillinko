...
export default function CatalogueEntry() {
 ...
 return <form action="/oil-and-gas" method="get" onSubmit={e=>{e.preventDefault();const d=new FormData(e.currentTarget);router.push(catalogueSearchUrl({search:String(d.get("search")||""),sector:String(d.get("sector")||"")}));}} className="mt-8 max-w-3xl rounded-xl bg-white p-4 text-[#142b40] shadow-lg">
