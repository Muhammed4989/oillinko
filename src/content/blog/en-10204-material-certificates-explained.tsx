    ...
    <>
      ...
      <Prose>
            ...
            <tbody>
              {[
                ...
                [
                  "3.2",
                  "An inspection certificate with results from specific testing, traceable to the actual product delivered",
                  "The manufacturer's authorized inspection representative independent of manufacturing, together with the purchaser's authorized inspection representative or the inspector designated by official regulations",
                ],
              ].map((r) => (
        ...
        <p className="mt-4 text-sm leading-relaxed text-muted sm:text-base">
          ...
          <Link
            className="text-accent hover:underline"
            href="/blog/category/inspection-material-quality/inspection-testing/third-party-inspection-tpi-oil-and-gas-equipment"
          >
          ...
          <Link
            className="text-accent hover:underline"
            href="/blog/category/oil-and-gas-procurement/supplier-selection-rfq/how-to-write-a-bill-of-quantities"
          >
            bill of quantities
          </Link>{" "}
        ...
        <p className="mt-4 text-sm leading-relaxed text-muted sm:text-base">
          ...
          and we can clarify the document requirement with you before seeking quotations.
        </p>
