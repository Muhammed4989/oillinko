...
const faqs = [
  ...
  {
    q: "Which API 610 edition should a pump enquiry specify?",
    ...
    <>
      ...
      <Prose>
        ...
        <p className="mt-6 text-sm leading-relaxed text-muted sm:text-base">
          ...
          and Oillinko will circulate it to potential manufacturers and
          ...
          <Link className="text-accent hover:underline" href="/blog/category/oil-and-gas-equipment/pumps-rotating-equipment/pump-factory-acceptance-testing-and-commissioning-checklist">
