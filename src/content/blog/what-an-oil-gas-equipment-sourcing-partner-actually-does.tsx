    ...
    <>
      ...
      <Prose>
        ...
        <p className="mt-4 text-sm leading-relaxed text-muted sm:text-base">
          ...
          <Link className="text-accent hover:underline" href="/blog/category/oil-and-gas-procurement/supplier-selection-rfq/how-to-write-a-bill-of-quantities">
            bill of quantities
          </Link>{" "}
        ...
        <p className="mt-4 text-sm leading-relaxed text-muted sm:text-base">
          ...
          <Link className="text-accent hover:underline" href="/blog/category/inspection-material-quality/materials-documentation/en-10204-material-certificates-explained">
        ...
        <p className="mt-4 text-sm leading-relaxed text-muted sm:text-base">
          ...
          <Link className="text-accent hover:underline" href="/blog/category/inspection-material-quality/inspection-testing/third-party-inspection-tpi-oil-and-gas-equipment">
        ...
        <p className="mt-6 text-sm leading-relaxed text-muted sm:text-base">
          ...
          , and we will circulate it to potential manufacturers, review the
          ...
          <Link
            className="text-accent hover:underline"
            href="/blog/category/oil-and-gas-procurement/supplier-selection-rfq/equipment-trading-companies-vs-buying-direct"
          >
