...
const faqs = [
  ...
  },
  {
    ...
    a: "Specify diaphragm rupture detection and ask the manufacturer to identify the arrangement provided. Double-diaphragm designs can monitor the space between diaphragms to detect a failure. The exact design, alarm function and applicable requirements must be confirmed for the offered pump and the project specification.",
  },
];
      ...
      <Prose>
        <p className="text-sm leading-relaxed text-muted sm:text-base">
          ...
          <a
            ...
            href="https://www.miltonroy.com/en/technologies/api-675-controlled-capacity-pumps/"
            target="_blank"
        ...
        <p className="mt-4 text-sm leading-relaxed text-muted sm:text-base">
          ...
          <Link className="text-accent hover:underline" href="/blog/category/oil-and-gas-equipment/pumps-rotating-equipment/api-674-api-676-positive-displacement-pumps-explained">
            API 674
          </Link>{" "}
        ...
        <p className="mt-4 text-sm leading-relaxed text-muted sm:text-base">
          ...
          and performance testing to the agreed requirements before shipment; witnessing must be defined in the inspection plan. The performance test
          ...
          mechanical running test of the agreed duration is also performed.
        ...
        <p className="mt-6 text-sm leading-relaxed text-muted sm:text-base">
          ...
          our guide to{" "}
          <Link className="text-accent hover:underline" href="/blog/category/oil-and-gas-equipment/pumps-rotating-equipment/api-682-mechanical-seal-piping-plans-explained">
