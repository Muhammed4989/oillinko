      ...
      <Prose>
        ...
        <p className="mt-4 text-sm leading-relaxed text-muted sm:text-base">
          ...
          <a
            ...
            href="https://store.astm.org/a0234_a0234m-24.html"
            target="_blank"
        ...
        <p className="mt-4 text-sm leading-relaxed text-muted sm:text-base">
          ...
          <Link className="text-accent hover:underline" href="/blog/category/oil-and-gas-procurement/supplier-selection-rfq/how-to-write-a-bill-of-quantities">how to write a bill of quantities</Link>
        </p>
        <p className="mt-4 text-sm leading-relaxed text-muted sm:text-base">
