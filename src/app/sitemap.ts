...
export default function sitemap(): MetadataRoute.Sitemap {
 const staticPages=["","/about","/services","/how-it-works","/quality",catalogueRoot,"/oil-and-gas/companies","/industries","/suppliers","/blog","/rfq","/contact"].map(p=>({url:site.domain+p,changeFrequency:"monthly" as const,priority:p===""?1:0.8}));
