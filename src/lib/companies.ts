...
export const companies: DirectoryCompany[] = [
  { id: "shandong-hugong-valve", name: "Shandong Hugong Valve Manufacturing Co., Ltd.", headquarters: "China", region: "Asia", role: "manufacturer", specialties: ["valves"], description: "Industrial valve manufacturer in Weifang, Shandong, with a catalogue spanning gate, globe, check, ball, butterfly, control and related valve families. Product standards, certifications, manufacturing origin and inspection evidence are confirmed for each quotation.", website: "https://www.cnvalve-mfg.com/", reviewedOn: "2026-09-22" },
